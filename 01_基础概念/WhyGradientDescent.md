# 从问题出发理解梯度下降与损失函数（Gradient Descent & Loss）
引入：源自于小红书评论区“如果你尝试在数学上推导大模型，那么说明还没有理解梯度下降的精髓”
---

## 一、问题起点：为什么“试图在数学上推导大模型”是误区？
